...
while start:
    ...
    if option == 1:
        ...
        cursor.execute("INSERT INTO TB_USER (LOGIN, CRYPTOGRAPHIC_PASSWORD) values ('"+email+"','"+newpassword+"');")
        ...
        print("\nThe user was successfully created\n")
            ...
            # --------------------------------------------------------------------------------
            cursor = connection.cursor()
            cursor.execute("SELECT ACCESS_COUNT FROM TB_USER WHERE LOGIN = '"+email+"' AND CRYPTOGRAPHIC_PASSWORD = '"+newpassword+"'")
